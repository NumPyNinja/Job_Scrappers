...
class Glassdoor:
    ...
    def glassdoor_get_jobs(self, job_name, job_location, jp_common):
        ...
        #see_jobs = WebDriverWait(self.driver, 5).until(
        #                EC.presence_of_element_located((By.XPATH, "//*[contains(@class,'link')]")))
        #see_jobs = WebDriverWait(self.driver, 5).until(
        #                EC.presence_of_element_located((By.CSS_SELECTOR, ".oregano-module-copy b")))

        
        #self.driver.find_element_by_xpath("//*[contains(@class,'link')]").click()
        #see_jobs.click()
        #test = self.driver.find_element_by_css_selector('[data-ga-lbl = Find a Job]').text
        #print(test)
